class Footer extends Component {
    ...
    initView(){
        ...
        <div>
            <div>
                ...
                <ul>
                    ...
                    <li><a href="">Grantie & Reparatie</a></li>
                </ul>
            </div>
            <div>
                <h4>Over ons</h4>
                <ul>
                    ...
                    <li><a href="">Werken bij RAMP</a></li>
            ...
            <div>
                <h4>Zakelijk met ons</h4>
                <ul>
                    <li><a href="">Zakelijk verkopen</a></li>
        ...
        <!-- logo at the bottom -->
        <div>
            <img src="img/placeholder_banner2.jpg" alt="Header of the site." height="100%">
        </div>
        <!-- bottom discloser -->
