...
// @route    POST api/productslists/cart/product/:productId
// @desc     Add a product to cart
// @access   Private
router.post('/cart/product/:productId', auth,
    async (req, res) => {
        try {
